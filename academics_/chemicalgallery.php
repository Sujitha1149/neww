...
<div class="vision-mission-bg">
        <h1 class="vision-mission-head">Chemical Engineering</h1>
</div>
<div class="d-md-none">
...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> Chemical Workshops</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
					<img src="photogal/chem3.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">Bridge Construction</h1>
						<p class="branch-gallery-card-des">The workshop bridge construction – beams, arches, trusses, suspensions, and test for maximum load</p>
					</div>
			</div>
             
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/chem1.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
				    <h1 class="branch-gallery-card-head text-center">sesmic Design</h1>
					<p class="branch-gallery-card-des">stay up to date on the latest building practices in designing for earthquakes.</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/chem2.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
					<h1 class="branch-gallery-card-head text-center">Transport Engineering</h1>
					<p class="branch-gallery-card-des">This workshop aims to provide working knowledge for analysis of traffic signaling systems and traffic density at junctions</p>
				</div>
			</div>               
        </div>
        
        <h1 class="chanc-about mb-3 mt-3"> Chemical Events</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/chem4.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">CHEMISMIC</h1>
						<p class="branch-gallery-card-des">CHEMISMIC event conducted on the occussion of Enigineers Day</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				...
				<div class="branch-gallery-content">
					...
					<p class="branch-gallery-card-des">Technical fest for CSe Department</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				...
				<div class="branch-gallery-content">
					...
					<p class="branch-gallery-card-des">Configure event Conducted for CSE DEpartment</p>
				</div>
			</div>               
        </div>
    </div>
