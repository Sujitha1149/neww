...
<div class="vision-mission-bg">
        <h1 class="vision-mission-head">Metallurgical & Material Engineering</h1>
</div>
<div class="d-md-none">
...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4">MME Workshops</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
					<img src="photogal/mme1.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">Industrial Thermology</h1>
						<p class="branch-gallery-card-des">Workshop on Industrial Thermology for two days</p>
					</div>
			</div>
             
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/mm3.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
				    <h1 class="branch-gallery-card-head text-center">Lectures of Steel Industry</h1>
					<p class="branch-gallery-card-des">Lectures on Steel Industry For MME Students</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/mme2.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
        ...
        <h1 class="chanc-about mb-3 mt-3">MME Events</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/mech4.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">MMEISMIC</h1>
						<p class="branch-gallery-card-des">MMEISMIC event conducted on the occussion of Enigineers Day</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
