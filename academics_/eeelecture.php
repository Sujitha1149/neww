...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        ...
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Electricity Technology and Machines.</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Electrical Engineering Material.</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Circuit Analysis, Electronics.</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Microprocessor interfacing.</a></p>
        </object>
    </div>
