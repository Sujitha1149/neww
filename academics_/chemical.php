...
<div class="container">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-3">Department Of Chemical Engineering</h1>
        <p class="chanc-pro-des">
Chemical engineering is an engineering field which deals with the study of operation and design of chemical plants as well as methods of improving production. Chemical engineers develop economical commercial processes to convert raw materials into useful products. Chemical engineering uses principles of chemistry, physics, mathematics, biology, and economics to efficiently use, produce, design, transport and transform energy and materials.</p>
        <h1 class="chanc-about mt-3">Vision</h1>
        <p class="chanc-pro-des">To educate the students to face the challenges pertaining to Chemical Engineering by maintaining continuous sprit on creativity, innovation, safety and ethics.</p>
        ...
        <ul class="vision-list-type">
                ...
                <li class="mission-links-des">
                To create Centre of Excellence in the emerging areas of Chemical Engineering.
                </li>
                <li class="mission-links-des">
