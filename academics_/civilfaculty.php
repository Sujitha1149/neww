...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about"> Civil Faculty</h1>
        <div class="faculty-cards-cont">
                <div class="governing-card mt-3 mb-3 w-100">
                    <div class="governing-img-card d-flex flex-row justify-content-center">
                        <img src="images/jayaramdir.jpg" class="governing-img" />
                    </div>
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">B.Jayarama Reddy</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">Professor & Head of the Departmet</p>
                            <p class="governing-card-des">Ph.D</p>
                            <p class="governing-card-des">hodcivil@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
                <div class="governing-card mt-3 mb-3 w-100">
                    <div class="governing-img-card d-flex flex-row justify-content-center">
                        <img src="images/rupas sir.jpeg" class="governing-img" />
                    </div>
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">M.Rupas KUmar</h1>
                        <div class="text-center mb-4">
                ...
                <div class="governing-card mt-3 mb-3 w-100">
                    <div class="governing-img-card d-flex flex-row justify-content-center">
                        <img src="images/sravan.jpg" class="governing-img" />
                    </div>
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">B.sravan</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">M.Tech</p>
                            <p class="governing-card-des">Assistant Professor</p>
                            <p class="governing-card-des">bsk@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
        </div>   
        <div class="faculty-cards-cont">
                <div class="governing-card mt-3 mb-3 w-100">
                    <div class="governing-img-card d-flex flex-row justify-content-center">
                        <img src="images/dilip.jpg" class="governing-img" />
                    </div>
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">R.Dileep</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">M.Tech</p>
                            <p class="governing-card-des">Assistant Professor</p>
                            <p class="governing-card-des">rdp@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
                <div class="governing-card mt-3 mb-3 w-100">
                    <div class="governing-img-card d-flex flex-row justify-content-center">
                        <img src="images/srikath.jpg" class="governing-img" />
                    </div>
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">K.srikanth</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">M.Tech</p>
                            <p class="governing-card-des">Assistant Professor</p>
                            <p class="governing-card-des">kgs@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
                <div class="governing-card mt-3 mb-3 w-100">
                    ...
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">Pavani Akkala</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">M.Tech</p>
                            <p class="governing-card-des">Assistant Professor</p>
                            <p class="governing-card-des">pavaniakkala@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="faculty-cards-cont">
                <div class="governing-card mt-3 mb-3 w-100">
                    ...
                    <div class="pb-2 pl-3 pr-3">
                        <h1 class="governing-card-head text-center">Dr.K Varun Teja</h1>
                        <div class="text-center mb-4">
                            <p class="governing-card-des">M.Tech,Ph.D</p>
                            <p class="governing-card-des">Assistant Professor</p>
                            <p class="governing-card-des">varuntejak@rguktong.ac.in</p>
                        </div>
                    </div>
                </div>
                <div class="governing-card mt-3 mb-3 w-100">
