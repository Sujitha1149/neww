...
<div class="vision-mission-bg">
        <h1 class="vision-mission-head">Civil Engineering</h1>
</div>
<div class="d-md-none">
...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> Civil Workshops</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
					<img src="photogal/civil1.jpeg" class="branch-gallery-img" />
            ...
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/civil2.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
            ...
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/civil3.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
        ...
        <h1 class="chanc-about mb-3 mt-3"> Civil Events</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/civil4.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">CIVILISMIC</h1>
						<p class="branch-gallery-card-des">CIVILISMIC event conducted on the occussion of Enigineers Day</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
