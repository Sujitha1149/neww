...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> Notifications </h1>
        <table class="mb-4">
                    <tr>
                        <th style="width: 10px;font-size:15px">S.No</th>
                        <th style="font-size:15px">Title</th>
                        <th style="font-size:15px">Detailed Notification</th>
                    </tr>
                    <tr>
                        <td>1</td>
                        <td>
                            <strong>CSEMIC Event</strong>
                            <img src="images/new1.gif" class="new1-gif-size"/>
                        </td>
                        <td>
                            <a href="pdf/ten1.pdf" target="_blank">Download</a>
                        </td>
