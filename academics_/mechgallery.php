...
<div class="vision-mission-bg">
        <h1 class="vision-mission-head">Mechanical Engineering</h1>
</div>
<div class="d-md-none">
...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> Mechanical Workshops</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
					<img src="photogal/mech1.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">IC Engine</h1>
						<p class="branch-gallery-card-des">Workshop on IC Engines for two days</p>
					</div>
			</div>
             
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/mech2.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
				    <h1 class="branch-gallery-card-head text-center">Auto Mobile Prototyping</h1>
					<p class="branch-gallery-card-des">Two days workshop on Auto Mobile Proto Typing</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/mech3.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
					<h1 class="branch-gallery-card-head text-center">Internet of Things(IOT)</h1>
					<p class="branch-gallery-card-des">Two days workshop on iot and applications</p>
				</div>
			</div>               
        </div>
        
        <h1 class="chanc-about mb-3 mt-3">Mechanical Events</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/mech4.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">MECHISMIC</h1>
						<p class="branch-gallery-card-des">MECHISMIC event conducted on the occussion of Enigineers Day</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/ece3.jpeg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
				    <h1 class="branch-gallery-card-head text-center">Innovfest</h1>
					<p class="branch-gallery-card-des">Technical fest for Mechanical Department</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				...
				<div class="branch-gallery-content">
					...
					<p class="branch-gallery-card-des">Configure event Conducted for Mechanical DEpartment</p>
				</div>
			</div>               
        </div>
    </div>
