...
<div class="container">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-3">Department Of Civil Engineering</h1>
        <p class="chanc-pro-des">Civil engineering is a professional engineering discipline that deals with the design, construction, and maintenance of the physical and naturally built environment, including public works such as roads, bridges, canals, dams, airports, sewage systems, pipelines, structural components of buildings, and railways.Civil engineering is traditionally broken into a number of sub-disciplines.</p>
        <h1 class="chanc-about mt-3">Vision</h1>
        <p class="chanc-pro-des">To educate the students to face the challenges pertaining to Civil Engineering by maintaining continuous sprit on creativity, innovation, safety and ethics.</p>
        ...
        <h1 class="chanc-about mt-3 mb-3">HOD Profile</h1>
            <div class="mb-3  d-flex flex-row">
                <div class="governing-img-card">
                    <img src="images/jayaramdir.jpg" class="hod-img" />
                </div>
                <div class="ml-4 d-flex flex-column justify-content-center">
                    <h1 class="hod-card-head">B.Jayarama Reddy</h1>
                    <div class="mb-4">
