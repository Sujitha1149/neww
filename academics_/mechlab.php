...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        ...
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                ...
                Academic Curriculum for Mechanical</a></p>
        </object>
        ...
        <table class="mb-3">
                    ...
                    <tr>
                        <td>3</td>
                        <td>Mechanical Measurement and Metrology Lab.</td>
                       
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>Mechanical Vibration Lab</td>
                        
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>Automobile Engineering Lab</td>
                        
                    </tr>
                    <tr>
                        <td>6</td>
                        <td>Fluid Machinery Lab</td>
