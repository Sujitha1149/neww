...
<div class="vision-mission-bg">
        <h1 class="vision-mission-head">Cvil Engineering</h1>
</div>
<div class="d-md-none">
...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        ...
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                ...
                Academic Curriculum for Civil</a></p>
        </object>
        ...
        <table class="mb-3">
                    ...
                    <tr>
                        <td>1</td>
                        <td>SURVEYING LABORATORY</td>
                        
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>CONCRETE TECHNOLOGY LABORATORY</td>
                    
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>FLUID MECHANICS LABORATORY</td>
                       
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>AUTO CAD LABORATORY</td>
                        
                    </tr>
                    <tr>
                        <td>5</td>
                        <td>ENVIRONMENTAL LABORATORY</td>
                        
                    </tr>
                    <tr>
                        <td>6</td>
                        <td>GEOTECHNICAL ENGINEERING LABORATORY</td>
