...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> CSE Workshops</h1>
            ...
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/workshop.jpeg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">Web Development</h1>
						<p class="branch-gallery-card-des">Workshop on Web Development for two days</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
                <img src="photogal/aca2.jpg" class="branch-gallery-img" />
				<div class="branch-gallery-content">
				    <h1 class="branch-gallery-card-head text-center">Python Programming</h1>
					<p class="branch-gallery-card-des">Two days cse workshop on Pyrthon Programming</p>
				</div>
			</div>   
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
        ...
        <h1 class="chanc-about mb-3 mt-3"> CSE Events</h1>
        <div class="faculty-cards-cont">
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
				<img src="photogal/lab3.jpg" class="branch-gallery-img" />
					<div class="branch-gallery-content">
						<h1 class="branch-gallery-card-head text-center">CSEISMIC</h1>
						<p class="branch-gallery-card-des">CSEISMIC event conducted on the occussion of Enigineers Day</p>
					</div>
			</div>  
            <div class="branch-gallery-card shadow-sm w-100 mt-3 mb-3">
