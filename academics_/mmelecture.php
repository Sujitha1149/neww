...
<div class="container mb-5">
    ...
    <div class="col-12 col-md-9">
        <h1 class="chanc-about mb-4"> Course Material</h1>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Material science</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Structure of Materials</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Introduction to Physical Metallurgy</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                materials science</a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                Material Energy Balance </a></p>
        </object>
        <object data="myfile.pdf" type="application/pdf" width="100%" height="100%">
                <p class="chanc-pro-des mb-3"> <a href="academics_/Academicregulations.pdf" target="_blank"> <i class="fa-solid fa-download mr-2 down-load-pic"></i>
                metallurgical Thermodynamics </a></p>
        </object>
    </div>
